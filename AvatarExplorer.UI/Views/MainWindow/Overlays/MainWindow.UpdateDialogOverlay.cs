...
public partial class MainWindow
{
    ...
    private async void UpdateDialogOverlay_UpdateNow_Click(object? sender, RoutedEventArgs e) => await LauncherService.OpenLink(this, SoftwareLink.LatestReleasePageURL);
    #endregion
}
