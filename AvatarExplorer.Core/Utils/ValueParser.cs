...
public static class ValueParser
{
    ...
    {
        if (string.IsNullOrEmpty(value)) return defaultValue;
        return double.TryParse(value, out var v) ? v : defaultValue;
    }

    public static DateTime DateTime(string? value)
    {
        if (string.IsNullOrEmpty(value)) return System.DateTime.MinValue;
        return System.DateTime.TryParse(value, CultureInfo.InvariantCulture, DateTimeStyles.None, out var d) ? d : System.DateTime.MinValue;
    }
